 ...
 */
public class OrderParserInvalidArgumentException extends  Exception{
    private String message;
    private String argumentName;
    private String invalidValue;

    public OrderParserInvalidArgumentException(String message, String argumentName, String invalidValue){
